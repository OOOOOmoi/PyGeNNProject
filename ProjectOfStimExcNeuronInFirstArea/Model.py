...
def get_parser():
    ...
    parser.add_argument("--speedup", action="store_true", help="Whether use multithread to speedup spike proccess")
    parser.add_argument("--thread-per-spike", type=int, default=NUM_THREADS_PER_SPIKE, help="Number of threads per spike for procedural synapses")
    return parser

def get_model_name(args):
    model_name = str(args.duration/1000)
    

if __name__ == "__main__":
    args = get_parser().parse_args()
    NUM_THREADS_PER_SPIKE = args.thread_per_spike
